"""
Django setting's for ecommerce project.
...
SECRET_KEY = 'django-insecure-q=c^tp=ietdkih(l1*n%hz+s=m4!xd04oavky3*h)ys^fxv3#u'
...
AUTH_USER_MODEL = 'accounts.User'  # wright it before doing migrations.
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'accounts.renderers.custom_exception_handler',
